...
function showTab(tabId) {
    ...
    if (fixedSaveButton) {
        // Only show the button when on the video-options tab
        fixedSaveButton.style.display = (tabId === 'video-options') ? 'block' : 'none';
    }
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (fixedSaveButton && videoOptionsTab && videoOptionsTab.classList.contains('active')) {
